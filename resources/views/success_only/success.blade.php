...
<body style="text-align: center;">
    ...
    <div style="border-radius:200px; height:200px; width:200px; background: #F8FAF5; margin:0 auto;">
      ...
      <h1 style="color: black; font-weight: 900; font-size: 40px; margin-bottom: 10px">Success</h1> 
      <a style="color: #404F5E; font-size: 20px; margin: 0;" href="/">Click here to return to Homepage</a>
    </div>
  </body>
